...
void load_settings() {
	...
	if (var_lang != "en" && var_lang != "nl" && var_lang != "de" && var_lang != "fr" && var_lang != "it" && var_lang != "ja" && var_lang != "ru" && var_lang != "es") var_lang = "en";
	var_lang_content = load_string("lang_content", "en");
	if (var_lang_content != "en" && var_lang_content != "nl" && var_lang_content != "de" && var_lang_content != "fr" && var_lang_content != "it" && var_lang_content != "ja" && var_lang_content != "ru" && var_lang_content != "es") var_lang_content = "en";
